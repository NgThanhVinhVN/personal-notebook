...
public interface NotebookRepository extends JpaRepository<Notebook, Long> {
    ...
    List<Notebook> findByUserAndIsDeletedFalseOrderByUpdatedAtDesc(User user);

    /** Pinned first, then by updatedAt desc */
    List<Notebook> findByUserAndIsDeletedFalseOrderByPinnedDescUpdatedAtDesc(User user);
    
    /** For Trash bin */
    List<Notebook> findByUserAndIsDeletedTrueOrderByUpdatedAtDesc(User user);
     ...
     */
    @Query("SELECT n FROM Notebook n WHERE n.user = :user AND n.isDeleted = false " +
